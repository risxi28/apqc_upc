...
Public Class cetakoutgoing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "APQC_UPC.cetakoutgoing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetakoutgoing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetakoutgoing = New cetakoutgoing()
        rpt.Site = Me.Site
        Return rpt
    End Function
